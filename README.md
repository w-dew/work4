...
1. **<font style="color:rgb(15, 17, 21);">计算光照向量</font>**<font style="color:rgb(15, 17, 21);">:</font>
    - `<font style="color:rgb(15, 17, 21);background-color:rgb(235, 238, 242);">L = normalize(light_pos - p)</font>`<font style="color:rgb(15, 17, 21);"> </font><font style="color:rgb(15, 17, 21);">(光线方向)</font>
    - `<font style="color:rgb(15, 17, 21);background-color:rgb(235, 238, 242);">V = normalize(ro - p)</font>`<font style="color:rgb(15, 17, 21);"> </font><font style="color:rgb(15, 17, 21);">(视线方向)</font>
    - `<font style="color:rgb(15, 17, 21);background-color:rgb(235, 238, 242);">R = normalize(reflect(-L, N))</font>`<font style="color:rgb(15, 17, 21);"> </font><font style="color:rgb(15, 17, 21);">(反射方向)</font>
...
3. <font style="color:rgb(15, 17, 21);">颜色裁剪: 使用 </font>`<font style="color:rgb(15, 17, 21);background-color:rgb(235, 238, 242);">ti.math.clamp(color, 0.0, 1.0)</font>`<font style="color:rgb(15, 17, 21);"> 确保颜色值在合法范围内</font>

### UI交互面板
<font style="color:rgb(15, 17, 21);">使用</font><font style="color:rgb(15, 17, 21);"> </font>`<font style="color:rgb(15, 17, 21);background-color:rgb(235, 238, 242);">ti.ui.Window.get_gui()</font>`<font style="color:rgb(15, 17, 21);"> </font><font style="color:rgb(15, 17, 21);">创建交互面板，提供4个滑动条：</font>
